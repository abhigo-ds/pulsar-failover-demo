...
import org.apache.pulsar.shade.org.apache.commons.lang3.EnumUtils;
...
public class ConsumerApp {
     ...
     * {@link org.apache.pulsar.client.impl.ControlledClusterFailover ControlledClusterFailover}
     * and creates a Consumer application which is then used to consume messages from
     * the pulsar topic.
     *
     * @param args CommandLine(CLI) arguments defining application characteristics.
     *             <ol>
     *                  <li>{@code args[0]} {@literal A name for the consumer to be started}
     *                  <li>{@code args[1]} {@literal Name:Type, these are colon seperated values.
     ...
     *                       </ol>
     *                  <li>{@code args[2]} {@literal Region where this application is hosted/deployed}
     *                  <li>{@code args[3]} {@literal Name of the group this app should belong to.
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        do { // Process message blacklog & wait CLIENT_WAIT_IN_SECONDS secs for new message
            ...
            if (msg != null) {
                receivedMsg = true;
                System.out.printf("Consuming: %s at %s on %s\n", new String(msg.getData()), util.getcurrentTime(), util.getCurrentServiceUrl());
