...
public class ConsumerApp {
	 ...
	 *             <ol>
	 *             <li>@Mandatory consumerName {args[0]} - A name for the consumer
	 *             to be started</li>
	 *             <li>@Mandatory region {args[1]} - Region where this application
	 *             is hosted/deployed</li>
	 *             <li>@Optional group {args[2]} - Name of the group this app should
	 *             belong to. This will help in determining the cluster where the
	 *             pulsar client will connect.</li>
	 *             </ol>
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Consumer<?> consumer = client.newConsumer().consumerName(util.getAppName())
				.topic(util.getConfig().getTopicFullPath()).subscriptionName(util.getConfig().getSubscription())
				.replicateSubscriptionState(true).subscriptionType(SubscriptionType.Exclusive).subscribe();
