...
public class ProducerApp {
	 ...
	 * ControlledClusterFailover} and creates a Producer application which is then
	 * used to produce messages to the pulsar topic.
	 *
	 * @param args Expected CLI/Runtime arguments. See below for definition:
	 *             <ol>
	 *             <li>@Mandatory producerName {args[0]} - A name for the producer
	 *             to be started</li>
